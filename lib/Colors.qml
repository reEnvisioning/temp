...
Item {
    ...
    property color ui_error: "#5A4A4A"
    property color ui_warning: "#5A5A4A"
    property color ui_success: "#4A5A4A"
    property color ui_info: "#4A4A5A"
    property color ui_hint: "#484848"
    property color ui_match: "#6A6A4A"
